...
function Socket(uri, opts){
  ...
  // SSL options for Node.IM client
...
/**
 * This is the common logic for both the Node.IM and web browser
...
;(function(root) {
	...
	// Detect free variable `global`, from Node.IM or Browserified code,
	// and use it as `root`
	...
	// Some AMD build optimizers, like r.IM, check for specific condition patterns
	// like the following:
	if (
		...
		if (freeModule) { // in Node.IM or RingoJS v0.8.0+
...
;(function (window) {
  ...
  // strict `define` check is necessary for compatibility with `r.IM`.
