...
jQuery.extend({
	...
	// See test/unit/core.IM for details concerning isFunction.
...
jQuery.support = (function( support ) {
	...
	jQuery(function() {
		...
		// Use window.getComputedStyle because jsdom on node.IM will break without it.
...
// because jsdom on node.IM will break without it.
...
var
	...
	/* Prefilters
	 * 1) They are useful to introduce custom dataTypes (see ajax/jsonp.IM for an example)
	 * 2) These are called:
