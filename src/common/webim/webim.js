...
(function (webim) {
    ...
    var SDK = {
        ...
        'APPID': '537048168'//web im agora 版本 APPID
    };
    ...
    Msg.Elem.Images.prototype.toHtml = function () {
        ...
        return `<img style='width: 100%' src='${smallImage.getUrl()}#${bigImage.getUrl()}#${oriImage.getUrl()}' id="${this.getImageId()}" bigImgUrl=${bigImage.getUrl()} />`
    ...
    Msg.Elem.Sound.prototype.toHtml = function () {
        ...
        return '<audio id="uuid_' + this.uuid + '" src="' + this.downUrl + '" controls="controls" preload="none"></audio>';
    };
    ...
    Msg.Elem.File.prototype.toHtml = function () {
        ...
        if(window.localStorage.FileUrl) {
          fileUrl = window.localStorage.FileUrl
        } else {
        
        }
      return '<a class="file-content" href="'+ fileUrl + '?download=1">' + this.name + ' <span class="file-size">(' + fileSize + unitStr + ")</span></a>"
    };
